package Lab05_Guess_Birthday_day;
...
public class GuessBirthday {
    ...
    public String Guess(int[][] Birthday) {
        String temp = ""; // Temporary variable to store user input
        for (int i = 0; i < Birthday.length; i++) { // Iterate through each set
            do {
                ...
                for (int j = 0; j < Birthday[i].length; j++) {
                    printFormattedNumber(Birthday, i, j);
                }
                System.out.println('\n');
